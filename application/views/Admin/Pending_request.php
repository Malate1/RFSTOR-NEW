                ...
                <div class="col-xs-12">
                    <div class="box box-primary">
                        <div class="box-header">
                            <h3 class="box-title">Pending Request per Group</h3>
                        </div>
                        ...
                        <div class="box-body">
                                ...
                                <div class="col-xs-3">
                                    <div class="form-group ">
                                        <form class="form-horizontal">
                                            ...
                                            <select style="width: 100%; padding:5px;" class="form-control select-type" name="request_type" id="request_type">
                                                <!-- <option></option> -->
                                                <option>RFS</option>
                                                <option>TOR</option>
                                                <option>ISR</option>
                            ...
                            <table class="table  table-striped  table-bordered table-hover dataTable no-footer" id="dt-pending" >
                                <thead>
                                    <tr role="row">
...
<script>
    $(document).ready(function(){
        ...
        let typeofrequest = $('#request_type').select2("val");
    ...
    function viewPendingRequest(usergroup,typeofrequest) {
        ...
        var table = $('table#dt-pending').removeAttr('width').DataTable({
            "destroy": true,
            'serverSide': true,
            'processing': true,
            // 'responsive': true,
