...
<body  class="login-page" style="height: auto;">
        ...
        <div class="modal-dialog modal-lg" >
            <div class="modal-content" style="border-radius: 10px">
                <div class="modal-header">
                    ...
                    <center><img src="<?=base_url()?>assets/dist/img/tor--rfs-high-resolution-logo-transparent.png" class="img-circle"  alt="logo" style="height: 50px; width: 44px;"></center> 
                ...
                <div class="modal-body" style="height: auto;">
                    <div class="row" style="padding-top: 20px; align-content: center;">
                        <p class="text-center" style="font-size: 12px;">For concerns regarding your account and requests access kindly contact your designated group/s. </p>
    ...
    </div><!-- /.login-box  Version 1.0 <strong>Copyright &copy; 2022 </strong> All rights
            reserved.-->
