                ...
                <div class="col-xs-12">
                    <div class="box box-primary">
                        ...
                        if($type == 'RFS'){ ?>
                            <div align="center" style="padding: 0px 12px 0px 12px;" >
                                <div  class="btn-group" style="width:100%; text-align: center;">
                                    ...
                                    <a id="Approved" class="btn btn-default status">Reviewed</a>
                        ...
                        <div style="padding: 0px 10px 10px 10px" class="box-body ">
                            ...
                            <br>
                            <table class="table  table-striped  table-bordered table-hover dataTable no-footer" id="dt-review" width="100%" >
                                <thead>
                                    <tr role="row">
...
<script>
    ...
    function viewRequest(req_status, date_from, date_to) {
        ...
        var table = $('table#dt-review').removeAttr('width').DataTable({
        ...
        $('table#dt-review').on('click', 'a', function() {
...
<script type="text/javascript">
  $(document).ready(function() {
    ...
    $("#reviewSideTree").addClass('active');
