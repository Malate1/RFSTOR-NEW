...
<div class="content-wrapper">
    ...
    <style type="text/css">
        ...
        /*     font-family: sans-serif;*/
             ...
             transition: .6s;
             margin: 0 50px 50px; /* Added 20px bottom margin */
        }
            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <!-- <p class="text-blk team-head-text">
                        ...
                        <p class="text-center m-auto" style="font-size: 14px;">For concerns regarding your account and requests access kindly contact your designated group. </p>
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-4 my-5" style="margin-bottom: 30px;">
                            <div class="card border-0">
                                <div class="card-body text-center">
                                    ...
                                    <address style="text-align: center;font-size: 14px;padding-bottom: 13px; ">Upper Ground, North Wing, Island City Mall, Tagbilaran City, Bohol, Philippines 6300 </address>
                                ...
                                <div class="card-body text-center">
                                    ...
                                    <table style="font-size: 14px; " align="center">
                                        <tr>
                                            ...
                                            <td style="text-align: left;">FARMS, ATP</td>
                                        </tr>

                                        <tr>
                                            <td style="padding: 4px;">1822</td>
                                            <td style="text-align: left;">PMS, TMS, BR, INSTITUTIONAL, CWO</td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align: left;">HRMS, CMS</td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td style="padding: 4px; text-align: center;">1809/1801</td>
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-4 my-5" style="margin-bottom: 30px;">
                            <div class="card border-0">
                                <div class="card-body text-center">
                                    ...
                                    <p style="font-size: 14px; "><a href="mailto:itsysdev@alturasbohol.com">itsysdev@alturasbohol.com</a></p>
                        ...
                        <div class="responsive-container-block container">
                                ...
                                <div class="responsive-cell-block wk-desk-3 wk-ipadp-3 wk-tab-6 wk-mobile-12 card-container">
                                  <div class="card">
                                    <div class="team-image-wrapper">
                                      <img class="team-member-image" src="http://172.16.161.34:8080/hrms/<?php echo $emp['21114-2013']->photo?>">
                                    </div>
                                    ...
                                    <p class="text-blk feature-text">
                                      <?php if($emp['21114-2013']->current_status != 'Active'){ ?>
                                        ...
                                        <?php }else{ ?>
                                            <span class="label label-success" style="font-size: 100%;"> <?php echo $emp['21114-2013']->current_status?> </span>
                                        <?php } ?>  
                                    </p>
                            ...
                            <div class="responsive-container-block">
                                ...
                                <div class="responsive-cell-block wk-desk-3 wk-ipadp-3 wk-tab-6 wk-mobile-12 card-container">
                                  <div class="card ">
                                    <div class="team-image-wrapper">
                                      <img class="team-member-image" src="http://172.16.161.34:8080/hrms/<?php echo $emp['02723-2022']->photo?>">
                                    </div>
                                    ...
                                    <p class="text-blk feature-text">
                                        <?php if($emp['02723-2022']->current_status != 'Active'){ ?>
                                            <span class="label label-danger" style="font-size: 100%;"> Inactive </span>
                                        <?php }else{ ?>
                                            <span class="label label-success" style="font-size: 100%;"> <?php echo $emp['02723-2022']->current_status?> </span>
                                        <?php } ?>    
                                    </p>
                                    <div class="social-icons">
                                      <!-- <a href="https://www.twitter.com" target="_blank">
                                ...
                                <div class="responsive-cell-block wk-desk-3 wk-ipadp-3 wk-tab-6 wk-mobile-12 card-container">
                                  <div class="card">
                                    <div class="team-image-wrapper">
                                      <img class="team-member-image" src="http://172.16.161.34:8080/hrms/<?php echo $emp['03845-2015']->photo?>">
                                    </div>
                                    ...
                                    <p class="text-blk feature-text">
                                        <?php if($emp['03845-2015']->current_status != 'Active'){ ?>
                                            <span class="label label-danger" style="font-size: 100%;"> Inactive </span>
                                        <?php }else{ ?>
                                            <span class="label label-success" style="font-size: 100%;"> <?php echo $emp['03845-2015']->current_status?> </span>
                                        <?php } ?>    
                                    </p>
                                    <div class="social-icons">
                                      <!-- <a href="https://www.twitter.com" target="_blank">
                                ...
                                <div class="responsive-cell-block wk-desk-3 wk-ipadp-3 wk-tab-6 wk-mobile-12 card-container">
                                  <div class="card">
                                    <div class="team-image-wrapper">
                                      <img class="team-member-image" src="http://172.16.161.34:8080/hrms/<?php echo $emp['03075-2022']->photo?>">
                                    </div>
                                    <p class="text-blk name text-uppercase">
                                    ...
                                    <p class="text-blk feature-text">
                                      <?php if($emp['03075-2022']->current_status != 'Active'){ ?>
                                            <span class="label label-danger" style="font-size: 100%;"> Inactive </span>
                                        <?php }else{ ?>
                                            <span class="label label-success" style="font-size: 100%;"> <?php echo $emp['03075-2022']->current_status?> </span>
                                        <?php } ?>    
                                    </p>
                                    <div class="social-icons">
                                      <!-- <a href="https://www.twitter.com" target="_blank">
                                ...
                                <div class="responsive-cell-block wk-desk-3 wk-ipadp-3 wk-tab-6 wk-mobile-12 card-container">
                                  <div class="card">
                                    <div class="team-image-wrapper">
                                      <img class="team-member-image" src="http://172.16.161.34:8080/hrms/<?php echo $emp['01472-2018']->photo?>">
                                    </div>
                                    <p class="text-blk name">
                                    ...
                                    <p class="text-blk feature-text">
                                      <?php if($emp['01472-2018']->current_status != 'Active'){ ?>
                                            <span class="label label-danger" style="font-size: 100%;"> Inactive </span>
                                        <?php }else{ ?>
                                            <span class="label label-success" style="font-size: 100%;"> <?php echo $emp['01472-2018']->current_status?> </span>
                                        <?php } ?>    
                                    </p>
                                    <div class="social-icons">
                                      <!-- <a href="https://www.twitter.com" target="_blank">
